...
import { X, ChevronDown, ChevronUp, TrendingUp, TrendingDown, Activity, BarChart2, Plus } from "lucide-react"
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-4 overflow-y-auto">
      <div className="bg-gray-900 rounded-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto relative">
        ...
        <button
          onClick={onClose}
          className="absolute top-4 right-4 p-2 bg-gray-800 hover:bg-gray-700 rounded-full text-gray-400 hover:text-white transition-colors z-10"
        >
          <X className="w-5 h-5" />
        </button>
                  ...
                  <div className="bg-green-900 bg-opacity-30 p-4 rounded-lg flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-green-400 text-sm mt-1">
                        {name} is not listed on the latest NBA injury report.
                      </p>
                    </div>
                  </div>
                )}
                  ...
                  <div className="bg-blue-900 bg-opacity-30 p-4 rounded-lg flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-blue-400 text-sm mt-1">
                        Monte Carlo simulation runs thousands of random scenarios based on historical data to predict
                        the probability of a player exceeding their points threshold. It accounts for variability in
                        performance and provides a more robust prediction than simple averages.
                      </p>
                    </div>
                  </div>
                </div>
